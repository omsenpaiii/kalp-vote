                ...
                <section className={`h-screen w-screen relative flex justify-center items-center`}>
                    <div
                        ...
                        <motion.h1
                            ...
                            className={`text-center text-[5rem] leading-[1rem]`}>WELCOME TO
                        </motion.h1>
                        <motion.h1
                            onMouseEnter={() => {
                                mousePosition.scaleX.set(10)
                        ...
                        <p
                            ...
                            className={`font-light text-[0.8rem] text-center uppercase text-gray-400`}>
                            Revolutionizing democracy with cutting-edge tech at the Build Hackathon
                        </p>
                ...
                >
                    <div className={`h-full w-[85%]`}>
                        ...
                        <div className={`flex justify-between items-center`}>
                            ...
                            <button className={`p-5 w-[10rem] border-[0.25px] border-white rounded-full`}>
                                Explore Candidates
                            </button>
                        </div>
...
const FifthSection = (): React.JSX.Element => {
    return (
        <section className={`w-screen h-screen flex mt-[13rem] justify-center items-center`}>
            <div className={`w-[85%] h-full bg-blue-300/10 flex flex-col justify-center items-center`}>
                <div className={`bg-white/10 flex-1 rounded-2xl overflow-hidden w-full`}>
                    <img
